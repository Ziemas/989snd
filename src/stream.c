...
/* 00022264 00023004 */ BOOL snd_InitVAGStreamingEx(/* 0x0(sp) */ SInt32 num_channels, /* 0x4(sp) */ SInt32 buffer_size, /* 0x8(sp) */ UInt32 read_mode, /* 0xc(sp) */ BOOL enable_streamsafe_from_ee) {
	/* -0x50(sp) */ SInt32 x;
	/* -0x4c(sp) */ SInt32 y;
	/* -0x48(sp) */ VAGStreamHeader *header;
...
/* 0002309c 000233d4 */ SInt32 snd_AllocateStreamResources(/* 0x0(sp) */ VAGStreamHeader **stream1, /* 0x4(sp) */ VAGStreamHeader **stream2, /* 0x8(sp) */ SInt32 stereo, /* 0xc(sp) */ SInt32 get_voices, /* 0x10(sp) */ SInt32 vol_group) {}
...
/* 00023578 00024618 */ UInt32 snd_PlayVAGStreamByLocEx(/* 0x0(sp) */ SInt32 loc1, /* 0x4(sp) */ SInt32 loc2, /* 0x8(sp) */ SInt32 offset1, /* 0xc(sp) */ SInt32 offset2, /* 0x10(sp) */ SInt32 vol, /* 0x14(sp) */ SInt32 pan, /* 0x18(sp) */ SInt32 vol_group, /* 0x1c(sp) */ UInt32 queue, /* 0x20(sp) */ SInt32 sub_group, /* 0x24(sp) */ UInt32 flags) {
	...
	/* -0x24(sp) */ VAGStreamHeader *thestream;
	/* -0x20(sp) */ VAGStreamHeader *thestreamR;
	/* -0x1c(sp) */ SInt32 core;
	/* -0x18(sp) */ SInt32 c_v;
	/* -0x14(sp) */ VAGStreamQueEntry *slot1;
	/* -0x10(sp) */ VAGStreamQueEntry *slot2;
	/* -0xc(sp) */ SInt32 x;
}
...
/* 00024618 0002478c */ SInt32 snd_GetVAGStreamQueueCount(/* 0x0(sp) */ UInt32 handle) {
	...
	/* -0x10(sp) */ VAGStreamQueEntry *walk;
	/* -0xc(sp) */ VAGStreamHeader *stream;
}

/* 0002478c 00024c28 */ void snd_TryPreBufferQueElement(/* 0x0(sp) */ VAGStreamHandlerPtr handler, /* 0x4(sp) */ UInt32 load_flags) {
	/* -0x20(sp) */ VAGStreamHeader *currstream;
	/* -0x1c(sp) */ VAGStreamHeader *thestream;
	/* -0x18(sp) */ VAGStreamHeader *thestreamR;
	/* -0x14(sp) */ SInt32 stereo;
}

/* 00024c28 000250b0 */ void snd_SetupVAGStream(/* 0x0(sp) */ VAGStreamHandlerPtr handler, /* 0x4(sp) */ VAGStreamHeader *stream, /* 0x8(sp) */ SInt32 loc, /* 0xc(sp) */ SInt32 offset, /* 0x10(sp) */ SInt32 part_of_queue, /* 0x14(sp) */ UInt32 flags) {
	/* -0x68(sp) */ EEVagStreamMonitor vsm;
	/* -0x28(sp) */ IOPVagStreamMonitor *vsmp;
...
/* 0002547c 0002581c */ void snd_PauseVAGStream(/* 0x0(sp) */ UInt32 handle) {
	...
	/* -0x20(sp) */ VAGStreamHeader *stream;
...
/* 000260f4 000261c0 */ BOOL snd_StreamHandlerIsBusyWithLoad(/* 0x0(sp) */ VAGStreamHandlerPtr hand) {
	/* -0x10(sp) */ VAGStreamHeader *stream;
}
...
/* 000262cc 00026aac */ void snd_KillVAGStreamEx(/* 0x0(sp) */ UInt32 handle, /* 0x4(sp) */ SInt32 from_where) {
	/* -0x28(sp) */ SInt32 core;
	/* -0x24(sp) */ SInt32 voice;
	/* -0x20(sp) */ VAGStreamHeader *master_stream;
	/* -0x1c(sp) */ VAGStreamHeader *stream;
...
/* 00026aac 000274e8 */ void snd_ProcessVAGStreamTick(/* 0x0(sp) */ VAGStreamHandlerPtr hand) {
	...
	/* -0xfc(sp) */ VAGStreamHeader *stream;
	/* -0xf8(sp) */ VAGStreamHeader *walk;
	/* -0xf4(sp) */ SInt32 done;
...
/* 000274e8 00027f94 */ SInt32 snd_CheckVAGStreamProgress(/* 0x0(sp) */ VAGStreamHeader *stream, /* 0x4(sp) */ SInt32 *dma_needed) {
	/* -0x38(sp) */ SInt32 core;
...
/* 00027f94 000281c8 */ void snd_FixVAGStreamSamplesPlayed(/* 0x0(sp) */ VAGStreamHeader *stream, /* 0x4(sp) */ UInt32 addr) {
...
/* 000283b4 000284a4 */ UInt32 snd_GetVAGStreamTimeRemaining(/* 0x0(sp) */ UInt32 handle) {
	/* -0x18(sp) */ VAGStreamHeader *stream;
	/* -0x14(sp) */ VAGStreamHandlerPtr hand;
...
/* 00029d84 0002a4ac */ SInt32 snd_GetStreamDataFromIOPMemory(/* 0x0(sp) */ SInt32 offset, /* 0x4(sp) */ SInt32 readbytes, /* 0x8(sp) */ UInt32 readsectors) {
	...
	/* -0x24(sp) */ int ii;
	/* -0x20(sp) */ int back;
	/* -0x20(sp) */ VAGStreamHeader *walk;
	/* -0x24(sp) */ VAGStreamHeader *master;
	/* -0x1c(sp) */ int i;
	/* -0x18(sp) */ int ii;
	/* -0x14(sp) */ int back;
	/* -0x10(sp) */ u_int c;
...
/* 0002a704 0002ae1c */ SInt32 snd_GetStreamDataFromMemoryStream(/* 0x0(sp) */ SInt32 offset, /* 0x4(sp) */ SInt32 readbytes, /* 0x8(sp) */ UInt32 readsectors, /* 0xc(sp) */ UInt32 flags) {
	...
	/* -0x10(sp) */ EEVagStreamMonitor *vsmp;
	/* -0xc(sp) */ IOPVagStreamMonitor *vsmp;
}
...
/* 0002b350 0002d704 */ void snd_VAGStreamLoadDoneThread() {
	...
	/* -0x60(sp) */ BOOL dead;
	/* -0x5c(sp) */ SInt32 i;
	/* -0x58(sp) */ VAGStreamHeader *walk;
	/* -0x54(sp) */ SInt32 dis;
	/* -0x50(sp) */ VAGStreamHandlerPtr hand;
	/* -0x4c(sp) */ VAGStreamHeader *stream;
	...
	/* -0x14(sp) */ VAGBuffer *next_buff;
}

/* 0002d704 0002dbdc */ void snd_RestartInterleavedStream(/* 0x0(sp) */ VAGStreamHandler *handler) {
	/* -0x18(sp) */ VAGStreamHeader *walk;
	/* -0x14(sp) */ SInt32 i;
	/* -0x10(sp) */ UInt32 overage;
}
...
/* 0002e414 0002e87c */ void snd_RepairIOPMemoryBuffer(/* 0x0(sp) */ VAGBuffer *buff) {
	/* -0x20(sp) */ SInt32 back;
	/* -0x1c(sp) */ SInt32 ii;
	/* -0x18(sp) */ VAGStreamHeader *walk;
	/* -0x14(sp) */ VAGStreamHeader *master;
	/* -0x10(sp) */ int i;
	/* -0xc(sp) */ u_int c;
}
...
/* 0002f418 00030474 */ void snd_StartVAGStreamSounding(/* 0x0(sp) */ VAGStreamHeader *stream, /* 0x4(sp) */ SInt32 do_sync_list) {
...
/* 00030678 0003085c */ VAGStreamHeader* snd_GetFreeVAGStream(/* 0x0(sp) */ SInt32 vol_group) {
	/* -0x18(sp) */ SInt32 intr_state;
	/* -0x14(sp) */ VAGStreamHeader *walk;
	/* -0x10(sp) */ SInt32 dis;
	/* -0xc(sp) */ SInt32 x;
}

/* 0003085c 00030958 */ SInt32 snd_AddVAGStreamDMABuffer(/* 0x0(sp) */ VAGBuffer *buffer) {
	/* -0x10(sp) */ SInt32 intr_state;
	/* -0xc(sp) */ SInt32 dis;
}

/* 00030958 00030ab8 */ BOOL snd_AddVAGStreamLoadBuffer(/* 0x0(sp) */ VAGBuffer *buffer) {
	/* -0x18(sp) */ SInt32 intr_state;
	/* -0x14(sp) */ VAGBuffer *walk;
	/* -0x10(sp) */ SInt32 dis;
}

/* 00030ab8 00030c18 */ void snd_RemoveVAGStreamLoadBuffer(/* 0x0(sp) */ VAGBuffer *buffer) {
	/* -0x18(sp) */ VAGBuffer *walk;
	/* -0x14(sp) */ SInt32 intr_state;
	/* -0x10(sp) */ SInt32 dis;
}

/* 00030c18 00030d78 */ void snd_RemoveVAGStreamDMABuffer(/* 0x0(sp) */ VAGBuffer *buffer) {
	/* -0x18(sp) */ VAGBuffer *walk;
	/* -0x14(sp) */ SInt32 intr_state;
	/* -0x10(sp) */ SInt32 dis;
}

/* 00030d78 00030e68 */ void snd_AddQueEntryToHandler(/* 0x0(sp) */ VAGStreamHandlerPtr handler, /* 0x4(sp) */ VAGStreamQueEntry *que) {
	/* -0x18(sp) */ VAGStreamQueEntry *walk;
	/* -0x14(sp) */ SInt32 intr_state;
	/* -0x10(sp) */ SInt32 dis;
}

/* 00030e68 00030fd8 */ VAGStreamQueEntry* snd_GetFreeQueSlot() {
	/* -0x18(sp) */ SInt32 x;
	/* -0x14(sp) */ SInt32 intr_state;
	/* -0x10(sp) */ SInt32 dis;
}

/* 00030fd8 0003107c */ void snd_FreeQueChain(/* 0x0(sp) */ VAGStreamQueEntry *que, /* 0x4(sp) */ BOOL is_stdio) {}
...
/* 000311a0 0003148c */ void snd_FreeVAGStreamResources() {
	/* -0x60(sp) */ VAGStreamHeader *hold;
	/* -0x5c(sp) */ VAGStreamHeader *walk;
	/* -0x58(sp) */ SInt32 dis;
...
/* 0003198c 00031aa0 */ void snd_AddStreamToHandler(/* 0x0(sp) */ VAGStreamHandlerPtr handler, /* 0x4(sp) */ VAGStreamHeader *stream) {
	/* -0x10(sp) */ VAGStreamHeader *walk;
}

/* 00031aa0 00031bb4 */ void snd_AddStreamToHandlerQueue(/* 0x0(sp) */ VAGStreamHandlerPtr handler, /* 0x4(sp) */ VAGStreamHeader *stream) {
	/* -0x10(sp) */ VAGStreamHeader *walk;
}

/* 00031bb4 00031c34 */ SInt32 snd_GetNumStreamChannels(/* 0x0(sp) */ VAGStreamHeader *stream) {
...
/* 00031dd4 00032160 */ void snd_SetVAGStreamSubGroupVolPan(/* 0x0(sp) */ UInt32 handle, /* 0x4(sp) */ SInt32 group, /* 0x8(sp) */ SInt32 vol, /* 0xc(sp) */ SInt32 pan) {
	/* -0x18(sp) */ VAGStreamHandlerPtr hand;
	/* -0x14(sp) */ VAGStreamHeader *stream;
	/* -0x10(sp) */ VAGStreamQueEntry *walk;
}
...
/* 00032160 0003286c */ void snd_SetVAGStreamVolPan(/* 0x0(sp) */ UInt32 handle, /* 0x4(sp) */ SInt32 vol, /* 0x8(sp) */ SInt32 pan) {
	...
	/* -0x24(sp) */ VAGStreamHeader *stream;
